...
/*   Updated: 2024/11/05 11:42:12 by matus            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			update_node_tar_index(t_node_stack *b,
...
void			prepare_stack_b(t_node_stack **a,
					t_node_stack **b, size_t total_len);
...
/* static void set_target_node_b_test(t_node_stack *a,
			t_node_stack *b, size_t stack_len);*/
...
void			assign_flag_to_node(t_node_stack *node,
					size_t min, size_t mid, size_t max);
void			flag_stack(t_node_stack *stack, size_t stacklen);
void			flag_stack_nodes(t_node_stack *stack,
					size_t min, size_t mid, size_t max);
...
t_node_stack	*process_iteration(t_node_stack **a,
					size_t *stack_length, size_t flag);
void			set_cheapest(t_node_stack *stack,
					size_t total_len, size_t flag);
void			handle_biggest(t_node_stack **a,
					t_node_stack *actual, t_node_stack *biggest);

// ---------------------- Group 6: Operations and Helpers ----------------------
void			mttp(t_node_stack **stack,
					t_node_stack *current, size_t median);
...
//-----------------------Missing Actions-----------------------
void			rotate_operation_ci(t_node_stack **a,
					t_node_stack *cheapest, size_t median);
void			push_operation_ci(t_node_stack *cheapest_node,
					t_node_stack **a, t_node_stack **b, size_t *tmp_slen_a);
size_t			check_flag(t_node_stack *stack, size_t *flag);
void			ft_putstr(char *str);
bool			is_cheaper(t_node_stack *current_node,
					size_t *cheapest_index, t_node_stack *cheapest_node);
void			reset_stack(t_node_stack *stack);
void			check_5con(t_node_stack **a,
					t_node_stack **b, size_t total_len);

// -------------- Group 7: Flag and Chunk Management ----------------------
void			calculate_chunks(size_t stacklen,
					size_t *min, size_t *mid, size_t *max);
